...
public class Inoue extends Player {
	public Inoue(int x, int y, MainPanel panel) {
		super(x, y, panel);
		this.x = x;
		this.y = y;
		this.panel = panel;
	...
	private static final int Inoue_SPECIAL = 0;
	private int bulletSpeed = 20;
	private int lifestock = 3;
	...
	public int special() {
		return Inoue_SPECIAL;
	}

	private void loadImage() {

		ImageIcon icon = new ImageIcon(getClass().getResource("Inoue.jpg"));
		image = icon.getImage();
